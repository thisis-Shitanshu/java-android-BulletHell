...
class BulletHellGame extends SurfaceView implements Runnable{
    ...
    // This is the constructor method that gets called from BulletHellActivity
    ...
    private void spawnBullet() {
        ...
        /*
        // Pick a random point on the screen to spawn a bullet
        ...
        velocityY = 1;
        // Randomly make velocityYnegative
    ...
    public void run() {
        while (mPlaying) {
            ...
            long frameStartTime = System.currentTimeMillis();
                ...
                long thisThisFrame = System.currentTimeMillis() - frameStartTime;
                if (thisThisFrame >= 1) {
                    mFPS = MILLIS_IN_SECOND / thisThisFrame;
                }
        }
    }
    ...
    private void detectCollisions() {
        ...
        // Check each bullet for an intersection with Bob's ReactF
        for (int i = 0; i < mNumBullets; i++) {
            ...
            if (RectF.intersects(mBullets[i].getRect(), mBob.getRect())) {
                ...
                // This flags that a hit occurred so that the draw method
                // "knows" as well
                mHit = true;
    ...
    private void draw() {
        if (mOurHolder.getSurface().isValid()) {
            ...
            mCanvas.drawText("Bullets: " + mNumBullets + " Shields: " + (mShield - mNumHits) + " Best Time: " + mBestGameTime / MILLIS_IN_SECOND, mFontMargin, mFontSize, mPaint);
    ...
    private void printDebuggingText() {
        ...
        mCanvas.drawText("Bob left: " + mBob.getRect().top, 10, debugStart + debugSize * 3, mPaint);
